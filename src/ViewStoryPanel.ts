...
export class ViewStoryPanel {
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    ...
    return `<!DOCTYPE html>
      ...
      <div data-id="${story.id}" data-username="${story.creatorUsername}" class="data-container">
        <img class="pic" src="${story.creatorAvatarUrl || `https://ui-avatars.com/api/?background=random&name=${encodeURI(story.creatorUsername)}`}" />
